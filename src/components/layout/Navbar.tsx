    ...
    <nav className="fixed top-0 w-full z-50 bg-background/80 backdrop-blur-xl border-b border-surface-container/50 px-6 py-4">
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        <div className="flex items-center gap-12">
          <Link href="/" className="text-3xl font-display font-extrabold text-primary tracking-tighter">
            La Lora
          </Link>
        ...
        <div className="flex items-center gap-4">
          <Link href="/login" className="hidden sm:block font-semibold text-sm hover:text-primary transition-colors">Login</Link>
