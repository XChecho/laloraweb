        ...
        <section className="max-w-7xl mx-auto px-6 py-12 md:py-20 flex flex-col md:flex-row items-center gap-12">
          ...
          >
            ...
            <div className="flex flex-wrap gap-4">
              <Link to="/restaurants" className="bg-secondary-container text-white px-8 py-4 rounded-full font-bold flex items-center gap-2 ambient-shadow-secondary hover:translate-y-[-2px] transition-all">
