          ...
          >
            ...
            <form className="space-y-6">
              ...
              <div className="flex items-center justify-between">
                ...
                <Link to="/forgot-password" text-sm className="text-sm text-primary hover:text-primary-container font-bold transition-colors">¿Olvidaste tu contraseña?</Link>
              </div>
            ...
            <div className="mt-8">
              ...
              <button 
                className="mt-6 w-full flex items-center justify-center gap-3 bg-surface-container text-on-surface font-bold py-4 rounded-full hover:bg-surface-container-high transition-all border border-transparent hover:border-surface-container-highest"
              >
            ...
            <p className="mt-10 text-center text-on-surface-variant text-sm">
              ¿No tienes una cuenta? <Link to="/contact" className="text-primary font-bold hover:underline">Regístrate</Link>
            </p>
          </motion.div>
        </div>
